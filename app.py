...
POINTS_MAP = {
    ...
    "Причіп": 2, "ПОЛОНЕНИЙ": 60, "Старлінк": 4, "Винос": 8, "Мавік нічний": 10, "Розвідка": 1,
    "Склад": 5, "Артилерія": 1
}
...
try:
    if category == "⚔️ Бригадні звіти":
        ...
        st.markdown(f"<h3 style='text-align:center; color:white;'>🔥 МОНІТОнтинг УРАЖЕНЬ ЗА {sel_ur} </h3>", unsafe_allow_html=True)
...
# =================================================================
# 5. БЛОК ТЕХНІЧНОЇ ПІДТРИМКИ (ПЛАВАЮЧИЙ В ПРАВОМУ НИЖНЬОМУ КУТКУ)
# =================================================================
st.markdown("""
    <style>
    .support-card {
    ...
    <div class="support-card">
        <p class="support-title">⚙️ ТЕХНІЧНА ДОПОМОГА</p>
        <p class="support-text"><span class="support-label">Тел:</span> +380 67 485 95 90</p>
