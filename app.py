...
POINTS_MAP = {
    ...
    "Склад": 5, "Артилерія": 1, "ФПВ": 6, "О/С 200": 12, "О/С300": 8,"FPV бомбер": 6,"Бомбер": 6,
    "НРК": 4,
}
...
try:
    if category == "⚔️ Бригадні звіти":
        ...
        # Оновлений стиль заголовка: додано золотий колір та темну тінь для контрасту
        ...
        # Оновлений стиль заголовка тут також (колір золото + тінь)
