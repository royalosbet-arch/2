...
# --- 2. ЕКРАН ВХОДУ (ОНОВЛЕНИЙ ВИРАЗНИЙ ДИЗАЙН) ---
def check_password():
    if "password_correct" not in st.session_state:
        ...
        with col_c:
            st.markdown("""
                <div style='background:rgba(255,255,255,0.04); padding:35px; border-radius:15px; border:1px solid rgba(255,255,255,0.15); text-align:center;'>
                    <div style='font-size: 45px; margin-bottom: 10px;'>🇺🇦</div>
                    <h2 style='color:white; margin-bottom: 0; font-weight: 700; letter-spacing: 1px; font-size: 32px;'>1 аемб</h2>
                    <p style='color:#ffd700; font-size: 16px; margin-top: 5px; font-weight: 600;'>77 ОАЕМБр • ДШВ ЗСУ</p>
                    <p style='color:#ffffff; font-size: 13px; margin-top: 25px; font-weight: 700; letter-spacing: 2px; text-transform: uppercase;'>СИТУАЦІЙНИЙ ЦЕНТР БАТАЛЬЙОНУ</p>
